//package templates;
//
//import com.dapm2.sink.config.SinkUtils;
...
//        System.out.println("PetrinetSink!!!");
//        PetriNet petriNet = (PetriNet) messageAndPortNumber.first();
//        SinkUtils.getPetriNetSavingService().savePetriNet(petriNet);
//        System.out.println("Petrinet Stored in DB!!!");
//        MutableGraph dotGraph = constructDotGraph(petriNet);
//        try {
//            fromGraph(dotGraph)
//                    .render(SVG)
//                    .toFile(new File("sink-service/src/main/resources/sinks/outputs/petriNet.svg"));
//        } catch (Exception e) {
